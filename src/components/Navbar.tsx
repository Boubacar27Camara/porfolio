...
const Navbar = ({ darkMode, toggleDarkMode }: NavbarProps) => {
    ...
    const colors = darkMode ? lightColors : darkColors;
            ...
            backdrop-blur-lg rounded-2xl px-4 lg:px-8 py-2 shadow-lg`}>
                ...
                w-full space-x-6 lg:space-x-8'>
                        ...
                        {navItems.map((item) => (
                            ...
                            >
                                ...
                                {activeSection === item.name.toLowerCase() && (
                                    ...
                                    className="absolute -bottom-1 left-0 right-0 h-0.5 bg-linear-to-r rounded-full from-blue-500 to-purple-500"></motion.div>
                                )}
                            </a>
                        ))}
                    </div>
                    <div className="flex items-center space-x-2">
                        ...
                        rounded-full bg-linear-to-r from-blue-500 to-purple-500
                        text-white shadow-md hover:shadow-lg text-white shadow`}>
                            Recrutez-moi
                        </motion.a>
                    </div>
                    {/* Mobile Menu Button */}
                ...
                {isMenuOpen && (
                    ...
                    className={`absolute top-full left-0 right-0 mt-2 lg:hidden 
                        ${darkMode
                            ? 'bg-gray-900/95'
                            : 'bg-white/95'
                        } backdrop-blur-lg rounded-xl shaddow-lg border ${
                        ...
                        whileTap={{ scale: 0.95}}
                        className={`block px-3 py-4 text-center font-semibold 
                        rounded-lg bg-linear-to-r from-blue-500 to-purple-500
